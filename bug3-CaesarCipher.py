...
#    return encryptMessage(message, cipherKey, alphabet) # Origin code returned cipherKey value
    return encryptMessage(message, decryptKey, alphabet) # Atler code to return decrpytKey value
