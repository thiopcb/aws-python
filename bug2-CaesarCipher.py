...
def encryptMessage(message, cipherKey, alphabet):
    encryptedMessage = ""
    uppercaseMessage = ""
#    uppercaseMessage = message # Origin code didn't convert the message to uppercase
    uppercaseMessage = message.upper() # Atler the code to convert the message to uppercase
