...
# In the Functions lab, you created a Caesar cipher program to 
# encrypt and decrypt a message. In this lab, you will use the Python 
# Debugger (pdb) to find and fix errors in buggy versions of the program.
...
#    return shiftAmount # Original returned value by input() in string
    return int(shiftAmount) # Alter returned value as integer
